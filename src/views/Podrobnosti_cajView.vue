<template>
  <button @click="$router.push({ name: 'Caj' })" class="tlacitlo btn btn-primary"><<< Späť na ponuku čaju</button>
  <div class="uvod" v-if="produkt">
    ...
    <article class="popisky">
      <p><strong>Zloženie:</strong> {{ produkt.zlozenie }}</p>
...
<script>
import { nacitaj_caj } from '../stores/caj_produkt.js';
